...
​2. Using the Solution Explorer pane, open the Add New Project dialog
...
Using the Solution Explorer, add a class for each to the
...
Before continuing with our database refinement process, let’s do one
